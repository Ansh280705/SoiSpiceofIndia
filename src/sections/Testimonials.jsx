...
const testimonials = [
  {
    ...
    role: "Yashoda Dental Clinic",
    review:
      "He is an excellent web developer who helped me develop my dream website. His skills, creativity, and attention to detail made the entire process smooth and successful",
    image: m1, // Points to imported image
  },

  {
    name: "Sagar Rathore",
    role: "Founder & Director, Malawa Public School",
    review:
      "He helped me create my school website and did an excellent job. His technical skills and clear understanding of requirements made the project smooth and successful",
    image: m2,
  },
  {
    name: "Akansha Rathore",
    role: "CEO at Nee's Physical Therapy",
    review:
      "He helped me create my physical therapy website using GoDaddy templates. His skills and attention to detail turned it into a modern and professional platform.",
    image: w2,
  },
];
